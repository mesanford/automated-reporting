              ...
              <div>
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                  <div>
                    ...
                    <p className="text-slate-500 font-medium mt-2">Analysis generated by Gemini 1.5 Pro</p>
                  </div>
                  
                  <div className="flex items-center gap-3">
                    <button className="px-6 h-12 bg-blue-600 text-white rounded-xl font-bold flex items-center gap-2 hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all">
                      Share Report
                    </button>
                  </div>
                </div>
